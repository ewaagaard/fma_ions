...
class BeamParameters_SPS:
    ...
    Nb:  float = 3.7e8 # measured ions per bunch on 2024-11-13, at 16:23 (lowest amount of noise), but 3.7e8 on 2024-11-25
    ...
    eyn: float = 1.246e-6 # measured 1.34 after 25 ms on 2024-11-19, but 1.246 on 2024-11-25
