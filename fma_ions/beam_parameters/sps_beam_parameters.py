...
class BeamParameters_SPS:
    ...
    sigma_z: float = 0.211 # measured with WCM on 2024-11-13
    exn: float = 2.58e-6 # measured 2.58 after 25 ms on 2024-11-19
    eyn: float = 1.3e-6 # measured 1.34 after 25 ms on 2024-11-19, but expect strong blow-up here
