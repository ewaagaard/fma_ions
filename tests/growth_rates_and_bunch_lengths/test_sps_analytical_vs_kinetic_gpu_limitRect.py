...
sps.run_analytical_vs_kinetic_emittance_evolution(Qy_frac=19, which_context='gpu', ibs_step=300,
                                                  beamParams=beamParams1, context=context, install_longitudinal_rect=True,
                                                  extra_plot_string='_longitudinalLimitRect_ideal_lattice_sigmaZ_0dot225')
sps.run_analytical_vs_kinetic_emittance_evolution(Qy_frac=19, which_context='gpu', ibs_step=300,
...
sps.run_analytical_vs_kinetic_emittance_evolution(Qy_frac=19, which_context='gpu', ibs_step=300,
                                                  beamParams=beamParams3, context=context, install_longitudinal_rect=True,
                                                  extra_plot_string='_longitudinalLimitRect_ideal_lattice_sigmaZ_0dot15')