"""
Check optics functions of normal Q20 sequence, find point with minimal and maximal D'x --> Dx is kept as fixed as possible
"""
import fma_ions
...
penalty3 = -twiss.dpx + (twiss.dx - twiss2.dx[0])**2
...
fig1.suptitle(
    r'Q20 min dpx: $q_x$ = ' f'{twiss2.qx:.4f}' r' $q_y$ = ' f'{twiss2.qy:.4f}' '\n'
...
fig2.suptitle(
    r'Q20 max dpx: $q_x$ = ' f'{twiss3.qx:.4f}' r' $q_y$ = ' f'{twiss3.qy:.4f}' '\n'
