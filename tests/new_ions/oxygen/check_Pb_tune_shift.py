"""
Check tune shift of SPS Pb beams with correct input parameters
"""
import fma_ions
...
print('SC tune shift 2 (raw quick check): dQx = {:.5f}, dQy = {:.5f}'.format(dQx0, dQy0))