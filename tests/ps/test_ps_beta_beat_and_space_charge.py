...
ps_fma = fma_ions.FMA(num_turns=120, n_linear=25, output_folder='Output_beta_beat_and_SC')

# Test generating a sequence with beta-beat
ps_seq = fma_ions.PS_sequence_maker()
ps_line, twiss = ps_seq.load_xsuite_line_and_twiss()

# Test installing space charge on this line
line_SC = ps_fma.install_SC_and_get_line(ps_line, fma_ions.BeamParameters_PS)
...
#line_SC_beat = ps_seq.generate_xsuite_seq_with_beta_beat(beta_beat=0.05, line=line_SC)