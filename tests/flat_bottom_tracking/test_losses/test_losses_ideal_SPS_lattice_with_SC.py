...
print('Installing space charge...')
fma_sps = fma_ions.FMA()
line = fma_sps.install_SC_and_get_line(line, fma_ions.BeamParameters_SPS, context=context)
line2 = fma_sps.install_SC_and_get_line(line2, fma_ions.BeamParameters_SPS, context=context)
line3 = fma_sps.install_SC_and_get_line(line3, fma_ions.BeamParameters_SPS, context=context)
