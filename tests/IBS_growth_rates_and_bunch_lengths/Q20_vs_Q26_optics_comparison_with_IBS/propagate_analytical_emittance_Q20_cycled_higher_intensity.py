"""
Propagate analytical emittance for cycled Q20 optics with parameters similar to nominal case - but higher nominal intensity
"""
import fma_ions
import numpy as np
...
line, twiss = sps_q20.load_xsuite_line_and_twiss()
...
with open('analytical_Q20_cycled.pickle', 'wb') as handle:
