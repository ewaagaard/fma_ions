...
sps = fma_ions.SPS_Flat_Bottom_Tracker(qx0=26.30, qy0=26.13, num_part=100, num_turns=200, turn_print_interval=1)
sps.track_SPS(install_SC_on_line=False, add_tune_ripple=True, dq=0.1, add_aperture=True, beta_beat=0.05,
