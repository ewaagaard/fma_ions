...
beamParams.Nb = 2.0e8
beamParams.exn = 1.1e-6
print(beamParams)

# Test default tracking with space charge and IBS on GPU context 
sps = fma_ions.SPS_Flat_Bottom_Tracker(num_turns=100, output_folder='output_ibs_sc_full_Qy_26dot19')
tbt = sps.track_SPS(which_context='gpu', add_aperture=True, install_SC_on_line=True, apply_kinetic_IBS_kicks=True, ibs_step=100,
