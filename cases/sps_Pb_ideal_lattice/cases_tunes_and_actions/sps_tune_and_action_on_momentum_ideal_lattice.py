...
fma_sps = fma_ions.FMA(output_folder='output_Pb_on_momentum_ideal_lattice_0dot25', z0=0., n_linear=1500)
fma_sps.run_SPS(load_tbt_data=True, make_single_Jy_trace=True)
...
Jx2, Jy2, Qx2, Qy2 = fma_sps.plot_tune_over_action(twiss_sps2, also_show_plot=True, case_name='z0 = 0')
