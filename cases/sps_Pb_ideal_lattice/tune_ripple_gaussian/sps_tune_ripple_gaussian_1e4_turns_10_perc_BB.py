...
sps_ripple = fma_ions.Tune_Ripple_SPS(ripple_period=ripples_per_turn, num_turns=10_000, n_part=10_000, output_folder='output_tune_ripple_860_Hz__gaussian_10_000_particles_1e4_turns_10_perc_BB')
