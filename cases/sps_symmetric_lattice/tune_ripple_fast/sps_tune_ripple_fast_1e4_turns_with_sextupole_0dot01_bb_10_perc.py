...
sps_ripple = fma_ions.Tune_Ripple_SPS(ripple_period=1_000, num_turns=10_000, n_linear=30, 
                                      output_folder='output_tune_ripple_fast_lse_0dot01_bb_10perc')
sps_ripple.run_ripple_and_analysis(load_tbt_data=False, install_SC_on_line=True, sextupolar_value_to_add=0.01, plot_random_colors=True,
                               also_show_plot=True, phase_sweep_up_to_turn=10000, phase_space_sweep_interval=200, beta_beat=0.1)
