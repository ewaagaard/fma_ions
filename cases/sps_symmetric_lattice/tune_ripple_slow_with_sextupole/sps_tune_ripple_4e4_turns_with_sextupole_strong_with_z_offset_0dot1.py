...
sps_ripple = fma_ions.Tune_Ripple_SPS(ripple_period=10_000, num_turns=20_000, n_linear=30, z0=0.1,
...
sps_ripple.run_ripple_and_analysis(load_tbt_data=True, install_SC_on_line=True, sextupolar_value_to_add=0.5, plot_random_colors=True,
                               ...
                               phase_sweep_up_to_turn=20_000, phase_space_sweep_interval=200, num_particles_to_plot=20)