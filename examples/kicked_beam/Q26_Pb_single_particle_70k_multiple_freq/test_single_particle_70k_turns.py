...
ripple_freqs =  np.hstack((np.arange(10., 100., 10), np.arange(100., 600., 50), np.arange(600., 1200., 100), np.arange(1200., 2401., 400))).ravel()
...
sps_kick.plot_tbt_data_to_spectrum(tbt_dict, ripple_freqs=ripple_freqs, transfer_function_bounds=[5, 2500])