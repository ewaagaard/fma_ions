...
script_names = ['sps_ideal_lattice_sc_ibs.py', 'sps_BB_sc.py', 'sps_BB_sc_ibs.py']
folder_names = ['sps_ideal_lattice_sc_ibs_2M_turns_binomial', 'sps_BB_sc_2M_turns_binomial', 'sps_BB_sc_ibs_2M_turns_binomial']
string_array = ['SC + IBS ideal lattice', 'SC with BB', 'SC + IBS with BB']    
