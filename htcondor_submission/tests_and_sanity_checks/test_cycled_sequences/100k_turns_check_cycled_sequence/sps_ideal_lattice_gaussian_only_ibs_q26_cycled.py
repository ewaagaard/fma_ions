...
tbt = sps.track_SPS(which_context='gpu', beamParams=beamParams, install_SC_on_line=False, apply_kinetic_IBS_kicks=True, distribution_type='gaussian', cycle_sequence_to_minimum_dpx=True)
