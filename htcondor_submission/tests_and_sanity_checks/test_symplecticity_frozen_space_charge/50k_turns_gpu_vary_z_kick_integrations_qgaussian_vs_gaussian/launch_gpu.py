...
script_names = ['sps_5percBB_sc_gaussian_2_kicks.py', 'sps_5percBB_sc_gaussian_5_kicks.py', 
                ...
                'sps_5percBB_sc_gaussian_40_kicks.py', 'sps_5percBB_sc_gaussian_80_kicks.py']
folder_names = ['sps_5percBB_sc_gaussian_2_kicks', 'sps_5percBB_sc_gaussian_5_kicks', 
                ...
                'sps_5percBB_sc_gaussian_40_kicks', 'sps_5percBB_sc_gaussian_80_kicks']
...
for i, script in enumerate(script_names):
    ...
    sub.submit_GPU(file_name, extra_output_name_str=folder_names[i], number_of_turn_string='50k_turns', job_flavour='nextweek')
