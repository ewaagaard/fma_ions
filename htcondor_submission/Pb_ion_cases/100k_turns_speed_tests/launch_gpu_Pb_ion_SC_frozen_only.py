...
master_name = '_SPS_Pb_SC_ideal_lattice'
num_turns = 100_000 # corresponds to about 3.46 s for protons
run_files = ['sps_run_1_tbt.py']

# Define script and folder names
script_names = run_files.copy()
folder_names = ['SPS_Pb_SC_ideal_lattice']
string_array = ['SC, Pb ideal lattice']    
...
tbt = sps.track_SPS(which_context='gpu', install_SC_on_line=True, beta_beat=None, add_sextupolar_errors=False, 
                add_non_linear_magnet_errors=False, add_tune_ripple=False, apply_kinetic_IBS_kicks=False)
