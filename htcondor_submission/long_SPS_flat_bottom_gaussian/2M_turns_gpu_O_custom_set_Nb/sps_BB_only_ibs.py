...
tbt = sps.track_SPS(ion_type='O', which_context='gpu', install_SC_on_line=False, beta_beat=0.1, add_non_linear_magnet_errors=True, 
                    apply_kinetic_IBS_kicks=True, ibs_step = 5000, beamParams=beamParams)
