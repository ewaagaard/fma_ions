...
script_names = ['sps_BB_sc_Qydot15_frozen.py', 'sps_BB_sc_Qydot15_quasifrozen.py', 'sps_BB_sc_Qydot15_PIC.py',
                'sps_BB_sc_Qydot19_frozen.py', 'sps_BB_sc_Qydot19_quasifrozen.py', 'sps_BB_sc_Qydot19_PIC.py',
...
folder_names = ['sps_BB_sc_Qydot15_frozen_30K_turns', 'sps_BB_sc_Qydot15_quasifrozen_30K_turns', 'sps_BB_sc_Qydot15_PIC_30K_turns',
                'sps_BB_sc_Qydot19_frozen_30K_turns', 'sps_BB_sc_Qydot19_quasifrozen_30K_turns', 'sps_BB_sc_Qydot19_PIC_30K_turns',
                'sps_BB_sc_Qydot25_frozen_30K_turns', 'sps_BB_sc_Qydot25_quasifrozen_30K_turns', 'sps_BB_sc_Qydot25_PIC_30K_turns']
string_array = ['Frozen SC, Qy = .15', 'Quasi-frozen SC, Qy = .15', 'PIC SC, Qy = .15',
                'Frozen SC, Qy = .19', 'Quasi-frozen SC, Qy = .19', 'PIC SC, Qy = .19',
