...
script_names = ['sps_10percBB_sc_qgaussian.py', 'sps_10percBB_sc_ibs_qgaussian.py',
...
folder_names = ['sps_10percBB_sc_qgaussian', 'sps_10percBB_sc_ibs_qgaussian',
...
string_array = ['sps_10percBB_sc_qgaussian', 'sps_10percBB_sc_ibs_qgaussian',
