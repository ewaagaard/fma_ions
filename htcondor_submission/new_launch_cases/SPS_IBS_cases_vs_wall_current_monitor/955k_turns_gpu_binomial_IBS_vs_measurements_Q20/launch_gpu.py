...
script_names = ['sps_ideal_lattice_sc_binomial.py', 'sps_BB_only_ibs_binomial.py', 'sps_ideal_lattice_only_ibs_binomial.py', 'sps_BB_only_ibs_binomial_before_RF_spill.py',
...
folder_names = ['sps_ideal_lattice_sc_binomial', 'sps_BB_only_ibs_binomial', 'sps_ideal_lattice_only_ibs_binomial', 'sps_BB_only_ibs_binomial_before_RF_spill',
...
string_array = ['Ideal lattice, no SC', 'IBS with BB, binomial', 'IBS with ideal lattice, binomial', 'IBS with BB before RF spill, binomial', 
