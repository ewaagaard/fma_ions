...
master_name = 'Q26_Pb_ions_SC_frozen_beta_beat_and_non_linear_Qx_scan_LSE_excitation_with_IBS'
num_turns = 130_000 # corresponds to 3s for SPS ions at flat bottom
Qy = 26.19
Qx_range = np.arange(26.28, 26.40, 0.01)
...
tbt = sps.track_SPS(which_context='gpu', distribution_type='qgaussian', install_SC_on_line=True, beta_beat=0.15, add_non_linear_magnet_errors=True, 
                    I_LSE=-10., apply_kinetic_IBS_kicks=True, ibs_step = 2000)
...
sub.copy_plot_script_emittances_for_scan(master_name, folder_names, scan_array_for_x_axis=Qx_range,
                                             ...
                                             extra_text_string='$Q_{y}$ = 26.19 - q-Gaussian beam\n IBS, Frozen SC, 15% $\\beta$-beat + non-linear magnet errors\nLSE excitation')