...
master_name = 'launch_gpu_Pb_lse_scan_with_ibs_and_50Hz_ripple_adaptive_sc_qx_26dot335'
LSE_strengths = np.array([0.0, 0.001, 0.005, 0.01, 0.05, 0.1, 0.5, 1.0, 3.5])
...
sub.copy_plot_script_emittances_for_scan(master_name, folder_names, scan_array_for_x_axis='np.array([0.0, 0.001, 0.005, 0.01, 0.05, 0.1, 0.5, 1.0, 3.5])',
