...
master_name = 'launch_gpu_Pb_lse_scan_with_ibs_and_50Hz_ripple_adaptive_sc'
LSE_strengths = np.array([0.0, 0.001, 0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5, 1.0, 1.5, 2.0, 2.5])
...
sub.copy_plot_script_emittances_for_scan(master_name, folder_names, scan_array_for_x_axis='np.array([0.0, 0.001, 0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5, 1.0, 1.5, 2.0, 2.5])',
                                             label_for_x_axis='$Q_{x}$', 
                                             extra_text_string='$Q_{x, y}$ = 26.31, 26.10 - q-Gaussian beam\n Frozen SC, 10% $\\beta$-beat + non-linear magnet errors\nLSE excitation')