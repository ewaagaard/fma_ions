...
master_name = 'Q26_Pb_ions_bunch_intensity_scan_ibs_only_130k_turns_effective_aperture'
...
tbt = sps.track_SPS(which_context='gpu', distribution_type='qgaussian', beamParams=beamParams, install_SC_on_line=False,
                    apply_kinetic_IBS_kicks=True, ibs_step = 2000, x_max_at_WS=0.025, y_max_at_WS=0.013)
