...
master_name = 'Q26_Pb_ions_50Hz_amplitude_scan_130k_turns_adaptive_SC_effective_aperture'
num_turns = 130_000 
Qy = 26.19
Qx = 26.31
...
sub.copy_plot_script_emittances_for_scan(master_name, folder_names, scan_array_for_x_axis='np.array([5, 23, 56, 79, 105, 132.8])',
