...
master_name = 'Q26_Pb_ions_bunch_intensity_scan_adaptive_sc_with_50Hz_ripple_130k_turns_effective_aperture'
...
tbt = sps.track_SPS(which_context='gpu', distribution_type='qgaussian', beamParams=beamParams, install_SC_on_line=True, add_beta_beat=True, 
                    add_non_linear_magnet_errors=True, add_tune_ripple=True, SC_adaptive_interval_during_tracking=100, x_max_at_WS=0.025, y_max_at_WS=0.013)
