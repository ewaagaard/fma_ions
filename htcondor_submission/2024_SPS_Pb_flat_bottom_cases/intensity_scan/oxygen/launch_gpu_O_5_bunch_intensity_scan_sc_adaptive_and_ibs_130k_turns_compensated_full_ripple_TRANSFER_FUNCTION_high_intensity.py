...
master_name = 'Q26_O_ions_bunch_intensity_scan_adaptive_sc_ibs_with_compensated_50_150_300_600_Hz_ripple_130k_turns_TRANSFER_FUNCTION_high_Nb'
...
Nb_array = ['2*1.3e8', '2*1.75e8', '2*2.215e8', '2*2.93e8', '2*3.202e8', '2*3.94e8']
exn_array = ['2*0.73e-6', '2*0.89e-6', '2*1.11e-6', '2*1.4e-6', '2*1.75e-6', '2*2.1e-6']
eyn_array = ['2*0.48e-6', '2*0.63e-6', '2*0.74e-6', '2*0.85e-6', '2*1.05e-6', '2*1.175e-6']
