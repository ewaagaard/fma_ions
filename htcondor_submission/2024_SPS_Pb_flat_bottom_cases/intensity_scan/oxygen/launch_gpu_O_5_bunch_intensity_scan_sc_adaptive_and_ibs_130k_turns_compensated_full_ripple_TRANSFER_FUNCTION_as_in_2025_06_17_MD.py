...
master_name = 'Q26_O_ions_bunch_intensity_scan_adaptive_sc_ibs_with_compensated_50_150_300_600_Hz_ripple_130k_turns_TRANSFER_FUNCTION_2025_06_17_MD'
num_turns = 130_000 # corresponds to about 3 s for SPS ions at flat bottom
Qy = [26.25, 26.19, 26.25]
Qx = 26.31

# Use measured 2025-06-17 O8+ SPS values
Nb_array = ['86.25e8', '86.25e8', '29e8']
exn_array = ['1.63e-6', '1.63e-6', '1.5e-6'] 
eyn_array = ['1.77e-6', '1.63e-6', '1.5e-6']
run_files = ['sps_oxygen_case_{}.py'.format(i+1) for i in range(len(Nb_array))]

# Define script and folder names
script_names = run_files.copy()
folder_names = ['sps_oxygen_case_{}'.format(i) for i in range(len(Nb_array))]
...
tbt.to_json(output_dir)
    '''.format(num_turns, Nb_array[i], exn_array[i], eyn_array[i], Qx, Qy[i])
    )
    run_file.close()
