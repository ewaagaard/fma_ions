...
master_name = 'Q26_Pb_ions_bunch_intensity_scan_adaptive_sc_ibs_130k_turns_no_aperture'
...
run_files = ['sps_run_leir_inj_{}_no_aperture_no_ripple.py'.format(i+1) for i in range(len(no_LEIR_inj))]

# Define script and folder names
script_names = run_files.copy()
folder_names = ['sps_no_leir_inj_{}_no_aperture_no_ripple'.format(no_LEIR_inj[i]) for i in range(len(no_LEIR_inj))]
