...
master_name = 'Q26_Pb_ions_bunch_intensity_scan_adaptive_sc_ibs_with_compensated_50_150_300_600_Hz_ripple_1M_turns_TRANSFER_FUNCTION_longer_run'
num_turns = 1_000_000 # corresponds to about 6 s for SPS ions at flat bottom
Qy = 26.19
Qx = 26.31
...
tbt = sps.track_SPS(which_context='gpu', distribution_type='qgaussian', beamParams=beamParams, install_SC_on_line=True, add_beta_beat=True, 
                    ...
                    SC_adaptive_interval_during_tracking=100, store_particles=True)
