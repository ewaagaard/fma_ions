...
master_name = 'Q26_Pb_ions_bunch_intensity_scan_adaptive_sc_ibs_50Hz_ripple_effective_aperture_CPU_30k_turns'
num_turns = 30_000
Qy = 26.19
Qx = 26.31
...
tbt = sps.track_SPS(which_context='cpu', distribution_type='qgaussian', beamParams=beamParams, install_SC_on_line=True, add_beta_beat=True, 
...
for i, script in enumerate(script_names):
    ...
    sub.submit_CPU(file_name, master_job_name=master_job_name, job_name=folder_names[i])
