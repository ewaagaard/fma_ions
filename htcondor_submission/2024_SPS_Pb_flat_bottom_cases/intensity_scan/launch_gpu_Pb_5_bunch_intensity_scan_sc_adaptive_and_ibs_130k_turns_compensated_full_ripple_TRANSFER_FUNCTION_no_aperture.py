...
run_files = ['sps_run_leir_inj_{}_no_aperture.py'.format(i+1) for i in range(len(no_LEIR_inj))]

# Define script and folder names
script_names = run_files.copy()
folder_names = ['sps_no_leir_inj_{}_no_aperture'.format(no_LEIR_inj[i]) for i in range(len(no_LEIR_inj))]
