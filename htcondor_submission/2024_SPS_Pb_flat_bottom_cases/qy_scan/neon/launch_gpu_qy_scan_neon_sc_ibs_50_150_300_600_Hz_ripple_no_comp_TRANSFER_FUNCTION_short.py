...
master_name = 'Qy_scan_neon_ibs_50_150_300_600_Hz_ripple_adaptive_sc_WITH_TRANSFER_FUNCTION_477k_turns_as_03_07_2025_MD_130k_turns'
num_turns = 130_000 # corresponds to 3s for SPS ions at flat bottom
Qx = 26.31
Qy_range = np.arange(26.10, 26.28, 0.01)
run_files = ['sps_neon_run_{}_tbt_qx_26dot31.py'.format(i+1) for i in range(len(Qy_range))]
