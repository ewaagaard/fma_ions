...
master_name = 'Q26_Pb_ions_Qy_scan_ibs_50_150_300_600_Hz_ripple_adaptive_sc_no_comp_WITH_TRANSFER_FUNCTION'
num_turns = 130_000 # corresponds to 3s for SPS ions at flat bottom
Qx = 26.31
Qy_range = np.array([26.14, 26.18, 26.20, 26.26])
...
sub.copy_plot_script_emittances_for_scan(master_name, folder_names, scan_array_for_x_axis='np.arange(26.10, 26.26, 0.01)',
