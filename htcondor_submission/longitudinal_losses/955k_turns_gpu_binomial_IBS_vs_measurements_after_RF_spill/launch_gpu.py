...
folder_names = ['sps_BB_only_ibs_binomial_860k_turns', 'sps_BB_only_ibs_binomial_emittances_860k_turns']
...
for i, script in enumerate(script_names):
    ...
    sub.submit_GPU(file_name, extra_output_name_str=folder_names[i], number_of_turn_string='860k_turns', job_flavour='nextweek', 
                   output_format='json')
