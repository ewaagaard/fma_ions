...
folder_names = ['sps_ideal_lattice_sc_10k_turns', 'sps_ideal_lattice_sc_Qs_factor_0dot1_10k_turns', 'sps_ideal_lattice_sc_Qs_factor_0dot01_10k_turns', 'sps_ideal_lattice_sc_Qs_factor_0dot5_10k_turns',
		'sps_ideal_lattice_sc_Qs_factor_0dot25_10k_turns', 'sps_ideal_lattice_sc_Qs_factor_2_10k_turns', 'sps_ideal_lattice_sc_Qs_factor_4_10k_turns']
...
for i, script in enumerate(script_names):
    ...
    sub.submit_GPU(file_name, extra_output_name_str=folder_names[i], number_of_turn_string='10k_turns', job_flavour='nextweek', 
                   output_format='json')
