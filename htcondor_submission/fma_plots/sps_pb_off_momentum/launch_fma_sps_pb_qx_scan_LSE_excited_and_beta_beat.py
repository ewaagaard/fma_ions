...
master_name = 'Q26_Pb_FMA_LSE_3_beta_beat_on_momentum_ideal_lattice_off_momentum'
...
fma_sps = fma_ions.FMA(n_linear=200, delta0=1e-3)
tbt = fma_sps.run_SPS(qx0={:.3f}, qy0={:.3f}, which_context = 'gpu', add_beta_beat=True, add_non_linear_magnet_errors=True, I_LSE=3.0)
