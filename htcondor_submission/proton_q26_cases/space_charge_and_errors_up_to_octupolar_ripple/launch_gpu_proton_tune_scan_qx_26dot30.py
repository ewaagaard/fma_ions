...
master_name = 'Q26_protons_SC_frozen_up_to_octupolar_errors_ripple_Qxdot30'
...
tbt = sps.track_SPS(ion_type='proton', which_context='gpu', install_SC_on_line=True, beta_beat=0.15, add_sextupolar_errors=True, add_octupolar_errors=True,
                add_non_linear_magnet_errors=True, add_tune_ripple=True, apply_kinetic_IBS_kicks=False)
...
sub.copy_plot_script_emittances_for_scan(master_name, folder_names, scan_array_for_x_axis=Qy_range,
                                             ...
                                             extra_text_string='$Q_{x}$ = 26.30\nFrozen SC, 15% $\\beta$-beat + up to octupolar\nmagnet errors + ripple')